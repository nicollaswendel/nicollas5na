...
def get_db_connection():
    return create_engine("postgresql://postgres:jfEifBYqynzyHSUjetElgKZHflmkutIT@autorack.proxy.rlwy.net:48635/railway") # Não colocamos string de conexão no código, essa por ser comum, colocamos para exemplificar. Fica vulnerável ao subir pro GitHub.
